    ...
    <div class="container">
		...
		<div style="float:left;">
            <form action="order_details.php" method="post">
                    ...
                    <input type="text" name="mobile" placeholder="Mobile" required maxlength="10"  value="<?php echo $mobile ?>"><br>
					<textarea rows="5" cols="25" name="address" placeholder="Address" required><?php echo $address ?></textarea><br>
                ...
                <br>
                 <center>
                    <input type="submit" name="submit" value="Submit &rsaquo;" style="color:white;background: linear-gradient(#666666, #000000);border: 1px solid white;border-radius: 6px;padding:8px;">
                </center>
            </form>
			</div>
