...
<body>
    <div class="container">
        ...
        <div class="content">
			<?php echo message(); ?>
            <form action="" method="post" onsubmit="return validate_fb();">

                <input type="text" placeholder="Name" id="name_jsid" autofocus/>
                <br />
                <br />
                <textarea rows="15" cols="70" placeholder="Feel free to give any suggestions.." id="fb_jsid"></textarea>
                <br />
                <br />
