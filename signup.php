    ...
    <div class="container">
		...
		<?php if(logged_in()) {  echo "<p style=\"color:black;font-family:Georgia;font-variant:small-caps;font-size:25px;\">Logged in as : <b><i>".$_SESSION["username"]."</i></b></p>"; }?>
            <form action="signup.php" method="post" onsubmit="return validate();">
                <fieldset>
                    <legend>Name :</legend>
                    <input type="text" name="fname" placeholder="First Name" id="fname_jsid" autofocus autocomplete="off"><br />
                    <input type="text" name="lname" placeholder="Last Name" id="lname_jsid" autocomplete="off"><br>
                </fieldset>
                <br>
                <fieldset>
                    <legend>Email :</legend>
                    <input type="text" name="email" placeholder="Email" id="email_jsid" autocomplete="off"><br />
                    <input type="text" name="username" placeholder="Username" id="username_jsid" autocomplete="off"><br>
                </fieldset>
                <br>
                <fieldset>
