...
<div style="float:right;">
        ...
        <div class="content">
 		...
 		<table align="center">
			...
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("wellness","fitness");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="hme">Health Monitor & Equipments</a><br />
 		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("wellness","hme");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="sca">Senior Care & Aids</a><br />
 		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("wellness","sck");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
