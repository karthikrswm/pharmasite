...
<div style="float:right;">
        ...
        <div class="content">
		 ...
		 <p>
            <a name="medi">Medications</a><br />
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","Medications");
            ...
            <br /><a name="all">Allergies</a><br />
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","Allergies");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="pain">Pain Relievers</a><br />
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","pain");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="adep">Anti-Depressants</a><br />
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","depression");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="aim">Anti-Itch Medications</a><br />
 		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","itch");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="atb">Anti-Tuberculosis (Tb) Medications</a><br />
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","tuberculosis");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="ab">Antibiotics</a><br />
 		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","Antibiotics");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="am">Asthma Medications</a><br />
 		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","asthma");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="cfm">Cold & Flu Medications</a><br />
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","cold");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="sd">Skin Diseases</a><br />
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","skin");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="wl">Weight Loss/Obesity Medications</a><br />
 		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","weight_loss");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a id="wn">Womens Need</a><br />
 		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("prescriptions","womens_need");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
