...
<div style="float:right;">
        ...
        <div class="content">
			...
			<p>
            <br /><a name="fa">First Aid</a><br />
 
 		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("otc","first_aid");
            ...
            <br /><a name="hc">Health Care</a><br />
             
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("otc","health");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
