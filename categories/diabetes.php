...
<div id="header">
        ...
        <div class="content">
			...
			<p>
            <br /><a name="fb">Food & Beverages</a><br />
  		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("diabetes","fb");
            ...
            <br /><a name="ns">Nutrition & Supplements</a><br />
  		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("diabetes","ns");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
