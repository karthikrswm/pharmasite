...
<div style="float:right;">
        ...
        <div class="content">
  		...
  		<table align="center">
			...
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("household","bfc");
  		...
  		<table align="center">
			...
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("household","hc");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
  		...
  		<table align="center">
			...
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("household","speciality");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
