...
<div style="float:right;">
        ...
        <div class="content">
			...
			<p>
            <br /><a name="bc">Body Care</a><br />
              
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("personal","body");
            ...
            <br /><a name="cs">Cosmetics</a><br />
              
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("personal","cosmetics");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="ec">Eye Care</a><br />
 		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("personal","eye");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="fk">Facial Kit</a><br />
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("personal","facial");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="hc">Hair Care</a><br />
 		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("personal","hair");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
            ...
            <br /><a name="lc">Lip Care</a><br />
			
		<table align="center">
			
			<?php 
				$i=1;
				$product_set = find_products_by_category_subcategory("personal","lip");
				while($product = mysqli_fetch_assoc($product_set))
				{	if($i%4==0) echo "<tr>";
			?>
			        <td>
